...
/**
 * Clase que extiende de {@link BicicletaUsadaEnVentaDTO} para manejar la transformacion entre
...
public class BicicletaUsadaEnVentaDetailDTO extends BicicletaUsadaEnVentaDTO{
     ...
     *
     * @param entity La entidad de bicicletaUsadaEnVenta a partir de la cual se construye el objeto
     */
