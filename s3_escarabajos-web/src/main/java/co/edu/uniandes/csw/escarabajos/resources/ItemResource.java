...
public class ItemResource {
     ...
     * </pre>
     *
     * @return JSONArray {@link ItemDetailDTO} - Los item encontrados en la
     ...
     * </pre>
     *
     * @param id Identificador del item que se esta buscando. Este debe ser una
     * cadena de dígitos.
     * @return JSON {@link ItemDetailDTO} - El item buscado throws
     * WebApplicationException {@link WebApplicationExceptionMapper} - Error de
     * lógica que se genera cuando no se encuentra el item
     */
    @GET
    @Path("{id: \\d+}")
    public ItemDetailDTO getItem(@PathParam("id") Long id) {
        ...
        return new ItemDetailDTO(entity, itemLogic.getReferenciaItem(entity));
    }
