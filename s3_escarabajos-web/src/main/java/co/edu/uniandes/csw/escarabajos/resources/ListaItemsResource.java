...
public class ListaItemsResource {
    ...
    /**
     * <h1>DELETE /api/clientes/{idCLiente}/listadeseos/items/{idItem} : Borra un item del listadeseos.</h1>
     * 
    ...
    public void vaciarListaDeseos(@PathParam("idListaDeseos") Long idListaDeseos){
     ...
     /**
     * <h1>GET /api/clientes/{idCliente}/listadeseos/items : Obtener los items del listadeseos del cliente.</h1>
     * 
     ...
     * </pre>
     * @param idCLiente El ID del cliente dueño del listadeseos del cual se buscan los items
     * @return JSONArray {@link ItemDetailDTO} - los items del listadeseos del cliente. Si no hay ninguna retorna una lista vacía.
     */
    @GET
