 ...
 * "/api" y este recurso tiene la ruta "accesorios".</i>
 *
 * <h2>Anotaciones </h2>
 * <pre>
...
public class AcessorioResource {
     ...
     * </pre>
     *
     * @param accesorio {@link AccesorioDTO} - el accesorio que se desea
     * guardar.
     * @return JSON {@link AccesorioDTO} - el accesorio guardado con el atributo
     * id autogenerado.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
     * Error de lógica que se genera cuando ya existe el accesorio.
     */
    @POST
     ...
     * </pre>
     *
     * @return JSONArray {@link AccesorioDTO} - Los accesorios encontrados en la
     ...
     * </pre>
     *
     * @param id Identificador del accesorio que se esta buscando. Este debe ser
    ...
    /**
     * <h1>PUT /api/accesorios/{id} : Actualizar el accesorio con el id
     * dado.</h1>
     * <pre>Cuerpo de petición: JSON {@link AccesorioDTO}.
     *
     ...
     * </pre>
     *
     * @param id Identificador del accesorio que se desea actualizar.Este debe
     * ser una cadena de dígitos.
     * @param accesorio {@link AccesorioDTO} - El accesorio que se desea
     * guardar.
     * @return JSON {@link AccesorioDTO} - El accesorio guardado.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
     * Error de lógica que se genera al no poder actualizar el accesorio.
     */
    @PUT
    @Path("{id: \\d+}")
     ...
     * </pre>
     *
     * @param id Identificador del accesorio que se desea borrar. Este debe ser
     * una cadena de dígitos.
     * @throws co.edu.uniandes.csw.escarabajos.exceptions.BusinessLogicException
     * si el accesorio no existe!
     */
    @DELETE
    @Path("{id: \\d+}")
