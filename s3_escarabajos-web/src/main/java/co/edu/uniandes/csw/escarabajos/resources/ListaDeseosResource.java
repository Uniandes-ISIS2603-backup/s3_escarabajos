...
public class ListaDeseosResource {
     ...
     * </pre>
     *
     * @param listadeseos {@link ListaDeseosDTO} - el listadeseos que se desea
     * guardar.
     * @return JSON {@link ListaDeseosDTO} - el listadeseos guardado con el
     * atributo id autogenerado.
     * @throws BusinessLogicException {@link BusinessLogicExceptionMapper} -
     * Error de lógica que se genera cuando ya existe el listadeseos.
     */
    @POST
     ...
     * </pre>
     *
     * @param id Identificador del listadeseos que se esta buscando. Este debe
    ...
    /**
     * <h1>PUT /api/listadeseoss/{id} : Actualizar el listadeseos con el id
     * dado.</h1>
     ...
     * </pre>
     *
     * @param id Identificador del listadeseos que se desea actualizar.Este debe
     * ser una cadena de dígitos.
     * @param listadeseos {@link ListaDeseosDTO} - El listadeseos que se desea
     * guardar.
    ...
    /**
     * No existe metodo delete listadeseos porque un listadeseos nunca debe ser
     * borrado
     */
    @DELETE
    @Path("{id: \\d+}")
